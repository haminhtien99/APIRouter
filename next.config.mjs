...
// The default build uses projectRoot so server.js stays at the standalone root.
const tracingRoot = process.env.NEXT_TRACING_ROOT_MODE === "workspace"
  ? join(projectRoot, "..")
  : projectRoot;
const proxyClientMaxBodySize = process.env.APIROUTER_PROXY_CLIENT_MAX_BODY_SIZE || "128mb";
