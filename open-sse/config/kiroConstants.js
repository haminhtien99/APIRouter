 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what apirouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a apirouter
 ...
 * The suffix is a apirouter request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a apirouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a apirouter synthetic thinking variant
...
/**
 * Resolve a apirouter model id to the real upstream Kiro model id, plus flags
