 ...
 * into apirouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are apirouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic apirouter variant set for a single upstream Kiro model.
 *
 ...
 * into apirouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
