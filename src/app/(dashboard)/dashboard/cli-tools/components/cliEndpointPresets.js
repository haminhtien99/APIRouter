...
const endpoints = createStore({
  storageKey: "apirouter.cliToolEndpointPresets",
  changeEvent: "apirouter:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "apirouter.cliToolApiKeyPresets",
  changeEvent: "apirouter:api-key-presets-changed",
  itemField: "key",
});
