...
// Build TOML config for APIRouter (openai provider mode)
const buildAPIRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect APIRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildAPIRouterConfig(baseUrl, apiKey || "sk_apirouter", model);
