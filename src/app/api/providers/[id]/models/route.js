...
// value. Use the same version as Codex request headers so newly released models are
// not quietly omitted from a successful response.
const CODEX_MODELS_URL = `https://chatgpt.com/backend-api/codex/models?client_version=${CODEX_CLI_VERSION}`;
