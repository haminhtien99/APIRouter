...
// and break recursive loops between apirouter instances connected to each other.
const INTERNAL_MODELS_FETCH_HEADER = "x-ar-internal-models-fetch";
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // apirouter instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another apirouter fetching our /models)
